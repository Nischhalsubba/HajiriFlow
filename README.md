...
**Branch-aware technical guide for [`agent/fix-employee-avatars-v6`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6)**

<p><img alt="branch: agent/fix-employee-avatars-v6" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Ffix-employee-avatars-v6&color=5965F2&style=flat-square"> <img alt="Python" src="https://img.shields.io/static/v1?label=&message=Python&color=24292F&style=flat-square"> <img alt="Docker" src="https://img.shields.io/static/v1?label=&message=Docker&color=24292F&style=flat-square"> <img alt="Docker Compose" src="https://img.shields.io/static/v1?label=&message=Docker%20Compose&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/codespaces/new?ref=agent%2Ffix-employee-avatars-v6"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/fix-employee-avatars-v6`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/README.md)
- [`site/assets/media-v5.js`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/site/assets/media-v5.js)
- [`site/index.html`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/site/index.html)
- [`tests/test_frontend_experience_v5.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/tests/test_frontend_experience_v5.py)
...
```mermaid
flowchart TD
    ROOT["HajiriFlow / agent/fix-employee-avatars-v6"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["migrations/"]
    ROOT --> P3["site/"]
...
|---|---|
| Interface | [`site`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/site), [`src`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/src) |
| Data | [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/migrations) |
| Quality | [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/.github) |
...
Relevant detected files: [`tests/test_permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/tests/test_permissions.py), [`src/hajiriflow/identity/permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/identity/permissions.py), [`src/hajiriflow/db/session.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/db/session.py).
...
Detected data areas: [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/migrations), [`migrations/script.py.mako`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/migrations/script.py.mako), [`migrations/env.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/migrations/env.py), [`migrations/versions/20260803_0001_identity_foundation.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/migrations/versions/20260803_0001_identity_foundation.py), [`tests/test_database.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/tests/test_database.py), [`src/hajiriflow/db/models/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/db/models/__init__.py), [`src/hajiriflow/db/models/identity.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/db/models/identity.py).
...
Relevant detected files: [`src/hajiriflow/worker/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/worker/__init__.py), [`src/hajiriflow/worker/__main__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/src/hajiriflow/worker/__main__.py).
...
- [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-employee-avatars-v6"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/fix-employee-avatars-v6/.github/workflows/ci.yml)
...
| Branch | [`agent/fix-employee-avatars-v6`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-employee-avatars-v6) |
