...
**Branch-aware technical guide for [`agent/readability-responsive-v4`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4)**

<p><img alt="branch: agent/readability-responsive-v4" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Freadability-responsive-v4&color=5965F2&style=flat-square"> <img alt="Python" src="https://img.shields.io/static/v1?label=&message=Python&color=24292F&style=flat-square"> <img alt="Docker" src="https://img.shields.io/static/v1?label=&message=Docker&color=24292F&style=flat-square"> <img alt="Docker Compose" src="https://img.shields.io/static/v1?label=&message=Docker%20Compose&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/codespaces/new?ref=agent%2Freadability-responsive-v4"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/readability-responsive-v4`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/README.md)
- [`docs/FRONTEND_DESIGN_SYSTEM_V4.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/docs/FRONTEND_DESIGN_SYSTEM_V4.md)
- [`site/assets/hajiriflow-v4.css`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/site/assets/hajiriflow-v4.css)
- [`site/assets/shell-v4.js`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/site/assets/shell-v4.js)
- [`site/index.html`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/site/index.html)
- [`tests/test_frontend_layout_v4.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/tests/test_frontend_layout_v4.py)
...
```mermaid
flowchart TD
    ROOT["HajiriFlow / agent/readability-responsive-v4"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["migrations/"]
    ROOT --> P3["site/"]
...
|---|---|
| Interface | [`site`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/site), [`src`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/src) |
| Data | [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/migrations) |
| Quality | [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/.github) |
...
Relevant detected files: [`tests/test_permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/tests/test_permissions.py), [`src/hajiriflow/identity/permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/identity/permissions.py), [`src/hajiriflow/db/session.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/db/session.py).
...
Detected data areas: [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/migrations), [`migrations/script.py.mako`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/migrations/script.py.mako), [`migrations/env.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/migrations/env.py), [`migrations/versions/20260803_0001_identity_foundation.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/migrations/versions/20260803_0001_identity_foundation.py), [`tests/test_database.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/tests/test_database.py), [`src/hajiriflow/db/models/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/db/models/__init__.py), [`src/hajiriflow/db/models/identity.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/db/models/identity.py).
...
Relevant detected files: [`src/hajiriflow/worker/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/worker/__init__.py), [`src/hajiriflow/worker/__main__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/src/hajiriflow/worker/__main__.py).
...
- [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/readability-responsive-v4"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/readability-responsive-v4/.github/workflows/ci.yml)
...
| Branch | [`agent/readability-responsive-v4`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/readability-responsive-v4) |
