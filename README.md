...
**Branch-aware technical guide for [`agent/production-portraits-live-v7`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7)**

<p><img alt="branch: agent/production-portraits-live-v7" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fproduction-portraits-live-v7&color=5965F2&style=flat-square"> <img alt="Python" src="https://img.shields.io/static/v1?label=&message=Python&color=24292F&style=flat-square"> <img alt="Docker" src="https://img.shields.io/static/v1?label=&message=Docker&color=24292F&style=flat-square"> <img alt="Docker Compose" src="https://img.shields.io/static/v1?label=&message=Docker%20Compose&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/codespaces/new?ref=agent%2Fproduction-portraits-live-v7"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/production-portraits-live-v7`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/README.md)
...
```mermaid
flowchart TD
    ROOT["HajiriFlow / agent/production-portraits-live-v7"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["migrations/"]
    ROOT --> P3["site/"]
...
|---|---|
| Interface | [`site`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/site), [`src`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/src) |
| Data | [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/migrations) |
| Quality | [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/.github) |
...
Relevant detected files: [`tests/test_permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/tests/test_permissions.py), [`src/hajiriflow/identity/permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/identity/permissions.py), [`src/hajiriflow/db/session.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/db/session.py).
...
Detected data areas: [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/migrations), [`migrations/script.py.mako`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/migrations/script.py.mako), [`migrations/env.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/migrations/env.py), [`migrations/versions/20260803_0001_identity_foundation.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/migrations/versions/20260803_0001_identity_foundation.py), [`tests/test_database.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/tests/test_database.py), [`src/hajiriflow/db/models/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/db/models/__init__.py), [`src/hajiriflow/db/models/identity.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/db/models/identity.py).
...
Relevant detected files: [`src/hajiriflow/worker/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/worker/__init__.py), [`src/hajiriflow/worker/__main__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/src/hajiriflow/worker/__main__.py).
...
- [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/production-portraits-live-v7"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/HajiriFlow/blob/agent/production-portraits-live-v7/.github/workflows/ci.yml)
...
| Branch | [`agent/production-portraits-live-v7`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7) |
