...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/frontend-application-redesign`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/frontend-application-redesign). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/frontend-application-redesign"]
