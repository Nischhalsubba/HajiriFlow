...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-netlify-app-shell`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/fix-netlify-app-shell). It is generated from the files present on this branch and preserves the project-authored README below.
...
| Detected stack | Python, Docker, Docker Compose, HTML, JavaScript, CSS |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-netlify-app-shell"]
