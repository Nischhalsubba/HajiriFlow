...
**Branch-aware technical guide for [`phase-1/auth-rbac-supabase-foundation`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation)**

<p><img alt="branch: phase-1/auth-rbac-supabase-foundation" src="https://img.shields.io/static/v1?label=&message=branch%3A%20phase-1%2Fauth-rbac-supabase-foundation&color=5965F2&style=flat-square"> <img alt="Python" src="https://img.shields.io/static/v1?label=&message=Python&color=24292F&style=flat-square"> <img alt="Docker" src="https://img.shields.io/static/v1?label=&message=Docker&color=24292F&style=flat-square"> <img alt="Docker Compose" src="https://img.shields.io/static/v1?label=&message=Docker%20Compose&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/HajiriFlow/codespaces/new?ref=phase-1%2Fauth-rbac-supabase-foundation"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `phase-1/auth-rbac-supabase-foundation`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/README.md)
...
```mermaid
flowchart TD
    ROOT["HajiriFlow / phase-1/auth-rbac-supabase-foundation"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["migrations/"]
    ROOT --> P3["site/"]
...
|---|---|
| Interface | [`site`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/site), [`src`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/src) |
| Data | [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/migrations) |
| Quality | [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/.github) |
...
Relevant detected files: [`migrations/versions/20260803_0002_session_versioning.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/migrations/versions/20260803_0002_session_versioning.py), [`tests/test_permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/tests/test_permissions.py), [`src/hajiriflow/identity/permissions.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/identity/permissions.py), [`src/hajiriflow/db/session.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/db/session.py).
...
Detected data areas: [`migrations`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/migrations), [`migrations/script.py.mako`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/migrations/script.py.mako), [`migrations/env.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/migrations/env.py), [`migrations/versions/20260803_0001_identity_foundation.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/migrations/versions/20260803_0001_identity_foundation.py), [`migrations/versions/20260803_0002_session_versioning.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/migrations/versions/20260803_0002_session_versioning.py), [`tests/test_database.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/tests/test_database.py), [`src/hajiriflow/db/models/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/db/models/__init__.py), [`src/hajiriflow/db/models/identity.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/db/models/identity.py).
...
Relevant detected files: [`src/hajiriflow/worker/__init__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/worker/__init__.py), [`src/hajiriflow/worker/__main__.py`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/src/hajiriflow/worker/__main__.py).
...
- [`tests`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation/tests)
...
- [`SECURITY.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/SECURITY.md)
...
```mermaid
flowchart LR
    CHANGE["Change on phase-1/auth-rbac-supabase-foundation"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/.github/workflows/ci.yml)
...
| Branch | [`phase-1/auth-rbac-supabase-foundation`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation) |
| Ownership | No CODEOWNERS file detected |
| Contributing | [`CONTRIBUTING.md`](https://github.com/Nischhalsubba/HajiriFlow/blob/phase-1/auth-rbac-supabase-foundation/CONTRIBUTING.md) |
