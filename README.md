...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/production-portraits-live-v7`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/production-portraits-live-v7). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/production-portraits-live-v7"]
