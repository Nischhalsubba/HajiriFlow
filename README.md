...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/identity-rbac-foundation`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/identity-rbac-foundation). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/identity-rbac-foundation"]
