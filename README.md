...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/dynamic-demo-redesign-v3`](https://github.com/Nischhalsubba/HajiriFlow/tree/agent/dynamic-demo-redesign-v3). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/dynamic-demo-redesign-v3"]
