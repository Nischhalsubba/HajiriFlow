...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`phase-1/auth-rbac-supabase-foundation`](https://github.com/Nischhalsubba/HajiriFlow/tree/phase-1/auth-rbac-supabase-foundation). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on phase-1/auth-rbac-supabase-foundation"]
