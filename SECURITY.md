...
HajiriFlow handles workforce identity, biometric attendance evidence, leave decisions, device credentials, and payroll controls. Security reports are treated as product-integrity issues, not ordinary feature requests.
...
The application-level copy of this policy lives at `app/SECURITY.md`; changes should keep both locations aligned until that duplicate is retired deliberately.
