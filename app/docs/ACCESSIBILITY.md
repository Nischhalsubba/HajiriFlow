...
- Search and select filters restore focus after the legacy demo renderer replaces the workspace DOM, so typing or changing a filter does not strand keyboard users.
